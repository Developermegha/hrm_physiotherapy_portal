				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Specific Notice List</div>
							</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Specific Notice</header>														
													</div>
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="<?php echo base_url(); ?>staff/add_notice_specific" id="addRow"
																		class="btn btn-info">
															...
															<table
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td><?php echo $not->batch; ?></td>
																		<td><?php echo $not->section; ?></td>
        ...
        function remove_notice(i)
        {
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            url: "<?php echo base_url('admin/remove_notice'); ?>", 
                            type: "POST", 
                            data: {id:i},
                            dataType: 'json',
                            success: function (data) {
