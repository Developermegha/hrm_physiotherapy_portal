				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Notes List</div>
							</div>
													...
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table
																...
																<tbody>
                                                                    <?php if(!empty($all_notes)){ $i = 1;  foreach($all_notes as $notes){?>
																	<tr class="odd gradeX">
																		<td class="patient-img"><?php echo $i; ?></td>
																		<td><?php echo $notes['staff']; ?></td>
																		<td class="left"><?php echo $notes['course']; ?></td>
																		<td class="left"><?php echo $notes['batch']; ?></td>
																		<td class="left"><?php echo $notes['section']; ?></td>
																		<td>																			
																			<button onclick="download('<?php echo $notes['id']; ?>')" class="btn btn-danger btn-xs">
																				<i class="fa fa-download "></i>
																			</button>
																		</td>
																		<td>
																			<a onclick="window.location.href = '<?php echo base_url(); ?>staff/edit_notes/<?php echo $notes['id']; ?>'" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>                                                                            
																			<a onclick="remove_notes(<?php echo $notes['id']; ?>)" class="btn btn-danger btn-xs">
