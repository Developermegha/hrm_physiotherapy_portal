...
<script>
	$(document).ready(function() {
		...
		$("#managefrm").submit(function(){
				$.ajax({
					url: "<?php echo base_url('management/updateProfile'); ?>", 
					data: $("#managefrm").serialize(),
					type: "POST", 
					dataType: 'json',
					success: function (response) {
						...
						if(data1.success) {
							...
							echo base_url(); ?>management/profile';
							 }, 2000); 
						} else {
