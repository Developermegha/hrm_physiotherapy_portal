																...
																<tbody>
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std1.jpg"
																				alt="">
																		</td>
																		<td>Rajesh</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std10.jpg"
																				alt="">
																		</td>
																		<td>Pooja Patel</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std2.jpg"
																				alt="">
																		</td>
																		<td>Sarah Smith</td>
																		<td class="center">Librarian</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std3.jpg"
																				alt="">
																		</td>
																		<td>John Deo</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std4.jpg"
																				alt="">
																		</td>
																		<td>Jay Soni</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std5.jpg"
																				alt="">
																		</td>
																		<td>Jacob Ryan</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url(); ?>assets/img/std/std6.jpg"
																				alt="">
																		</td>
																		<td>Megha Trivedi</td>
																		<td class="center">Librarian</td>
