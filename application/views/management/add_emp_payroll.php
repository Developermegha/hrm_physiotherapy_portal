			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<form method="post" action="<?php echo base_url()?>management/add_payroll">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div
											...
											<select  name="name" class="form-control" style="width:200;">
                                            
                                            <?php  
                                          //  print_r($all_employee);die; 
                                            foreach($all_employee as $emp){      ?>
                                            <option  value="<?php echo $emp->firstname; ?>"><?php echo $emp->firstname; ?> </option>
                                            <?php } ?>
                                        </select>
									 ...
									 <div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtEmail" name="emp_id">
