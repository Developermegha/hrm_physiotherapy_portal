...
class Admin extends CI_Controller {
    ...
    public function login_user() {
        ...
        $result = $this->college_model->loginuser($data);
        if($result) { 
    ...
    public function profile()
    {
        ...
        if($id)
        {
            ...
            $this->load->back_template('admin/profile_view',$data);
        }
        else
        {
            $this->login();
    ...
    public function getStaffName()
    {
        ...
        if(!empty($regno)){
            $result =  $this->college_model->getStaffName($regno);
        }
    }
    
    
    public function add_professor() {
        $this->load->back_template('admin/add_professor');
    }
    ...
    public function add_prof_insert() {
        $data = array(
                     ...
                     'mobile' => $this->input->post('prof_mobile'),
    ...
    public function all_professors()
    {
        ...
        $this->load->back_template('admin/all_professors', $data);
    }
 
    public function add_leave()
    {
        $data['allstaff'] =  $this->college_model->getAllStaff();
        $this->load->back_template('admin/add_leave',$data);
    }
    ...
    public function add_leaveapplication()
    {
        ...
        if($id){
            redirect(base_url()."admin/all_leave");
        }
    }
    ...
    public function all_leave()
    {
     ...
     $this->load->back_template('admin/all_leaves',$data);
    }
    ...
    public function addNoticeGeneral()
    {
        $data = array(
            ...
            if($result) {
                redirect(base_url('')."admin/all_notice_general");
            } else {
                $res = array(
                    'success'=>false,
                    'msg'=>'Something went wrong.');
    ...
    public function add_notice_general(){
        $this->load->back_template('admin/add_notice_general');
    }
    ...
    public function edit_professor()
    {
        ...
        if($userid)
        {
            ...
            $this->load->view('admin/edit_professor', $data);
        }
        else
        {
            $this->login();
    ...
    public function change_status()
    {
        ...
        $remove_prof = $this->college_model->change_status($id,$status);
        if($remove_prof)
        {
            $res = array(
                        'success' => true,
...

    {
        ...
        $this->load->back_template('admin/emp_payroll', $data);
    }
    ...
    public function add_emp_payroll()
    {
        ...
        // print_r($data['all_employee']);die;
         $this->load->back_template('admin/add_emp_payroll',$data); 
    }
            ...
            $conveyance_amount=$this->input->post('conveyance_amount');
             ...
             $data=array(
                 ...
                 "updated_at"=>$date,
                  ...
                  if($id)
                  {
                    redirect(base_url()."admin/all_emp_payroll") ; 
                  }
                // print_r($data);die;
    }
    ...
    {
      $this->load->back_template('admin/payroll_bulk');    
    }
    ...
    public function all_notice_general()
    {
        ...
        $this->load->back_template('admin/all_notice_general',$data);
    }
    ...
    public function award_list(){
        ...
        $data['allawards'] = $this->college_model->getAllawards();
        $this->load->back_template('admin/awards_list',$data);
    }        
     
    public function add_award(){
        $data['allstaff'] =  $this->college_model->getAllStaff();
        $this->load->back_template('admin/add_award',$data);
    }
    ...
    public function saveaward(){
        ...
        $saveArray = array(
            'recognize' => $this->input->post('recognise'),
            'achievement' => $this->input->post('achievement'),
            'prize' => $this->input->post('prize'),
            'status' => 1,
            'employee_id' => $this->input->post('staffid')

        );

        $result = $this->college_model->insertAward($saveArray);
        if($result){
            redirect(base_url('admin/award_list'));
        }else{
            redirect(base_url('admin/add_award'));
        }
    ...
    public function holidays()
    {
         ...
         $this->load->back_template('admin/list_holidays',$data);
    }
    public function add_holiday()
    {
       $this->load->back_template('admin/add_holidays');    
    }
