 ...
 * 
  ...
  eContactPersonNumber: eContactPersonNumber,
  ...
  hostelOrHome: hostelOrHome,

  hostelName: hostelName,
  hRoomNumber: hRoomNumber,
  hWardenNumber: hWardenNumber,
  roommateName: roommateName,
  roommateEmail: roommateEmail,
  roommatePhone: roommatePhone,
  philippinesAddress: philippinesAddress,
  houseOwnerName: houseOwnerName,
  howseOwnerEmail: howseOwnerEmail,
  houseOwnerPhone: houseOwnerPhone,
  currentBatch: currentBatch,
  studied: studied,
  yearOfStartBS: yearOfStartBS,
  monthBS: monthBS,
  yearOfStartMD: yearOfStartMD,
  monthMD: monthMD
 */
?>
<!doctype html>
                    ...
                    <div class="col-lg-10 col-sm-12">
                        <div class="formWrap">
                            ...
                            <ul class="progressWrap">
                                ...
                                <li>Step 5 : Education Details</li>
                            </ul>
                            <form  action="" method="post" class="registration-form">
                                    ...
                                    <ul class="formListing">
                                        <li class="half">
                                            <div class="formField">
                                                ...
                                                <input type="text" id="studentIdNumber"  placeholder="Student Id Number">
                                            </div>
                                        </li>
                                        <li class="half">
                                            <div class="formField">
                                                <label>Philippines Phone Number (+63)</label>
                                                <input type="number" onfocusout="validateMobile(this.value,1)"  id="philippinesPhone"  placeholder="Philippines Phone Number">
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                ...
                                                <input type="file" id="foto" placeholder="Email">
                                            </div>
                                        </li>
                                        <li class="thirds">
                                            <div class="formField">
                                    ...
                                    <ul class="formListing">
                                        ...
                                        <li class="half">
                                            <div class="formField">
                                                ...
                                                <input type="text" id="temporaryAddress" placeholder="Temporary Address in home country">
                                            </div>
                                        </li>
                                        <li class="half"></li>
                                        ...
                                        <li class="thirds"></li>
                                        <h2 class="text_style">Passport Details</h2>
                                        <li class="half">
                                            <div class="formField">
                                        ...
                                        <li class="half">
                                            <div class="formField">
                                                ...
                                                <input type="text" id="eContactPerson" placeholder="Emergency contact">
                                            </div>
                                        </li>
                                        <li class="thirds">
                                            <div class="formField">
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                ...
                                                <input type="text" id="placeOfIssue" placeholder="Place of issue">
                                            </div>
                                        </li>
                                        <li class="thirds">
                                            <div class="formField">
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                ...
                                                <input type="date" id="visaExpiryDate" placeholder="Visa Expiry Date">
                                            </div>
                                        </li>
                                ...
                                <fieldset>
                                    <ul class="formListing"> 
                                        <li>
                                            ...
                                            <div id="ifyes" class="HostelYes boxcheck showHide1">
                                                <ul>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Hostel Name</label>
                                                            <div class="selectWrap">
                                                                <select id="hostelName" class="select2" style="width:100%;">
                                                                    <option value="">-- select one --</option>
                                                                    <option value="U park">U park</option>
                                                                    <option value="Happy Home">Happy Home</option>
                                                                    <option value="Hanbat">Hanbat</option>
                                                                    <option value="Rose">Rose</option>
                                                                    <option value="Tulip">Tulip</option>
                                                                    <option value="Lily">Lily</option>
                                                                    <option value="Orchid">Orchid</option>
                                                                    <option value="Jasmine">Jasmine</option>
                                                                    <option value="Oroderm">Oroderm</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            ...
                                                            <input type="text" id="hRoomNumber" placeholder="Hostel Room Number">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Hostel Warden Name</label>
                                                            <input type="text" id="hWardenNumber" placeholder="Hostel Warden Name">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Roommate Name</label>
                                                            <input type="text" id="roommateName" placeholder="Roommate Name">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Roommate Email</label>
                                                            <input type="email" id="roommateEmail" placeholder="Roommate Email">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Roommate Phone Number</label>
                                                            <input type="text" id="roommatePhone" placeholder="Roommate Phone Number">
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>

                                            <div id="ifno" class="HostelNo boxcheck showHide2">
                                                <ul>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>Address in Philippines</label>
                                                            <input type="text" id="philippinesAddress" placeholder="Address in Philippines">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>House owner Name</label>
                                                            <input type="text" id="houseOwnerName" placeholder="House owner Name">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>House owner Email</label>
                                                            <input type="email" id="howseOwnerEmail" placeholder="House owner Email">
                                                        </div>
                                                    </li>
                                                    <li class="half">
                                                        <div class="formField">
                                                            <label>House owner phone number</label>
                                                            <input type="text" id="houseOwnerPhone" placeholder="House owner phone number">
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <fieldset>
                                    <ul class="formListing"> 
                                            ...
                                            <div class="formField">
                                                ...
                                                <div class="selectWrap">
                                                    <select id="currentBatch" class="select2" style="width:100%;">
                                                        <option value="">-- select one --</option>
                                                        <option value="IMD - 15">IMD - 15</option>
                                                        <option value="IMD - 16">IMD - 16</option>
                                                        <option value="IMD - 17">IMD - 17</option>
                                                        <option value="IMD - 18">IMD - 18</option>
                                                        <option value="IMD - 19">IMD - 19</option>
                                                        <option value="IMD - 20">IMD - 20</option>
                                                        <option value="IMD - 21">IMD - 21</option>
                                                        <option value="IMD - 22">IMD - 22</option>
                                                    ...
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                            <select id="monthBS" class="select2" style="width:100%;">
                                                                ...
                                                                <option value="Apr">June</option>
                                                                <option value="Apr">July</option>
                                        ...
                                        <li>
                                            <div class="formField">
                                                <label>Year and month of start of M.D course</label>
                                                <ul class="d-flex justify-content-between">
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                            <select id="yearOfStartMD" class="select2" style="width:100%;">
                                                    ...
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                            <select id="monthMD" class="select2" style="width:100%;">
                                                                <option value="">Month</option>
                                                                <option value="Jan">Jan</option>
                                                                <option value="Feb">Feb</option>
                                                                <option value="March">March</option>
                                        ...
                                        <li>
                                            <div class="formField">
                                                ...
                                                <ul class="d-flex justify-content-between">
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                            <select id="accommodation" class="select2" style="width:100%;">
                                                                <option value="">Please Select</option>
                                                                <option value="Need Accommodation">Need Accommodation</option>
                                                                <option value="Do Not Need Accommodation">Do Not Need Accommodation</option>
                                                            </select>
                                                        </div>
                                                    </li>
                                                    <li class="half mb-0">
                                            ...
                                            <div class="formField">
                                                ...
                                                <ul class="d-flex justify-content-between">
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                            <label>Name</label>
                                                            <input type="text" id="" placeholder="Name of the person responsible for fees">
                                                        </div>
                                                    </li>
                                                    <li class="half mb-0">
                                                        <div class="selectWrap">
                                                ...
                                                <ul class="d-flex justify-content-between">
                                                    <li class="thirds mb-0">
                                                        <div class="selectWrap">
                                                            ...
                                                            <input type="text" id="" placeholder="Relationship">
                                                        </div>
                                                    </li>
                                                    <li class="thirds mb-0">
                                                        <div class="selectWrap">
                                                            <div class="selectWrap">
                                                                ...
                                                                <input type="text" id="" placeholder="Contact Number">
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="thirds mb-0">
                                ...
                                <fieldset>
                                    <ul class="formListing"> 
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                <label>10<sup>th</sup> Percentage(Don't use)</label>
                                                <input type="text" id="tenthPercentage" placeholder="10th Standard Percentage" readonly="">
                                            </div>
                                        </li>
                                        <li class="thirds"></li>
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                <label>NEET Score (optional)</label>
                                                <input type="text" id="neetScore" placeholder="NEET Score">
                                            </div>
                                        </li>
                                        <li class="thirds">
                                            <div class="formField">
                                        ...
                                        <li class="thirds">
                                            <div class="formField">
                                                <label>12<sup>th</sup> Percentage(Don't use)</label>
                                                <input type="text" id="twelvethPercentage" readonly="">
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="ctaWrap">
                                                ...
                                                <!--<button type="button" onclick="registration()" class="btn btn-next">Submit</button>-->
                                            </div>
                                        </li>
                                    </ul> 
                                </fieldset>
