    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="VerificationIndex.php">
                    <div class="sidebar-brand-text mx-3">DMSF</div>
                </a>
                <hr class="sidebar-divider my-0">
                <li class="nav-item active">
                    <a class="nav-link" href="VerificationIndex.php">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="leftpanelData">
                                            ...
                                            <div class="dataWrap">
												...
												<p><span>Verification : In Verification Section</span> </p>
												<p><span>Correction : </span> </p>
												<p><span>Finance : </span> </p>
												<p><span>Submission : </span> </p>
                                                <!-- <p><span>Remark : </span> <?php echo $rema['remark']; ?></p>-->
                                                <button title="Add Remark" data-toggle="modal" data-target="#glassAnimals" class="but-add-remark btn btn-primary" ><i class="fa fa-trash" aria-hidden="true"></i> Delete Application </button>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Are you sure want to delete this document?</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
                                                                    <li>
                                                                        <input type="hidden" id="pid" value="<?php echo $_REQUEST['id']; ?>">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" onclick="deleteStudent()" class="btn btn-success">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="divider"></div>
                                                <a href="#" title="Reject" data-toggle="modal" data-target="#rejectModal" class="btn btn-sm btn-danger shadow-sm float-left font_class margin-right-1" ><i class="fa fa-trash" aria-hidden="true"></i> Reject </a>
                                                <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
																	...
																	<li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk7"
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction('-2','7')" class="btn btn-danger">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="#" title="Hold" data-toggle="modal" data-target="#holdModal" class="btn btn-sm btn-warning shadow-sm float-left font_class margin-right-1" ><i class="fa fa-box-open" aria-hidden="true"></i> Hold </a>
                                                <div class="modal fade" id="holdModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
																	...
																	<li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk6"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction('-6','6')" class="btn btn-warning">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="#" title="Approved" data-toggle="modal" data-target="#approveModal" class="btn btn-sm btn-success shadow-sm float-left font_class margin-right-1" ><i class="fa fa-check-circle" aria-hidden="true"></i> Approved </a>
                                                <div class="modal fade" id="approveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
                                                                    <li>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk5"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                    </li>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction1('3','5')" class="btn btn-success">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                
                                                <a href="#" title="Approved" data-toggle="modal" data-target="#crrModal" class="btn btn-sm btn-secondary shadow-sm float-left font_class margin-right-1" ><i class="fa fa-check-circle" aria-hidden="true"></i> Correction </a>
                                                <div class="modal fade" id="crrModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Are you sure want to send this document to correction?</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
                                                                    <li>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk4"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                    </li>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction('2','4')" class="btn btn-success">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
