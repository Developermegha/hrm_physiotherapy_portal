    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="FinanceIndex.php">
                    <div class="sidebar-brand-text mx-3">DMSF</div>
                </a>
                <hr class="sidebar-divider my-0">
                <li class="nav-item active">
                    <a class="nav-link" href="FinanceIndex.php">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="leftpanelData">
                                            ...
                                            <div class="dataWrap">
												...
												<p><span>Finance : In finance Section</span> </p>
												<p><span>Submission : </span> </p>
                                               <!-- <p><span>Remark : </span> <?php echo $rema['remark']; ?></p>
                                                <a href="#" title="Add Remark" data-toggle="modal" data-target="#glassAnimals" class="but-add-remark" ><i class="fa fa-plus" aria-hidden="true"></i> Add Remark </a> -->
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
                                                                    ...
                                                                    <li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="remark1"
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" onclick="addRemark()" class="btn btn-success">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
																	...
																	<li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk13"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction('-4','13')" class="btn btn-danger">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="holdModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <ul class="remark-detail">
																	...
																	<li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk12"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveFunction('-8','12')" class="btn btn-warning">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="approveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                                ...
                                                                <ul class="remark-detail">
                                                                    ...
                                                                    <li>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select type="text" class="form-control" id="consultantName" >
                                                                                <option value="">Select Here</option>
                                                                                <option value="Dr.Lalit Patel">Dr.Lalit Patel</option>
                                                                                <option value="Maayug Educare">Maayug Educare</option>
                                                                                <option value="SOLOMAN">SOLOMAN</option>
                                                                                <option value="Dr.Ajin Wycliff">Dr.Ajin Wycliff</option>
                                                                                <option value="SURESH SNAP">SURESH SNAP</option>
                                                                                <option value="Abhijit Gayke/Suresh snap">Abhijit Gayke/Suresh snap</option>
                                                                                <option value="PADMA">PADMA</option>
                                                                                <option value="Mrs.Shushmita">Mrs.Shushmita</option>
                                                                                <option value="Ms.Indra">Ms.Indra</option>
                                                                                <option value="JUHI CHAWLA">JUHI CHAWLA</option>
                                                                                <option value="VIBHA">VIBHA</option>
                                                                                <option value="Abhijit Gayke">Abhijit Gayke</option>
                                                                                <option value="IRFAN JAMADAR">IRFAN JAMADAR</option>
                                                                                <option value="ASHIN MOHAN">ASHIN MOHAN</option>
                                                                                <option value="Mrs.Jecintha">Mrs.Jecintha</option>
                                                                                <option value="YUKTI BELWAL">YUKTI BELWAL</option>
                                                                                <option value="SHAILENDRA">SHAILENDRA</option>
                                                                                <option value="TRICITY IMMIGRATION">TRICITY IMMIGRATION</option>
                                                                                <option value="INDOMADE EDUCARE">INDOMADE EDUCARE</option>
                                                                                <option value="JAY AMBE GUJARAT">JAY AMBE GUJARAT</option>
                                                                                <option value="UDDHAV KHEDKAR">UDDHAV KHEDKAR</option>
                                                                                <option value="ATMIA EDUCATION/Dr.Ajin">ATMIA EDUCATION/Dr.Ajin</option>
                                                                                <option value="Shushmita/Dr.Sagar">Shushmita/Dr.Sagar</option>
                                                                                <option value="RAJATHANGAPPAN">RAJATHANGAPPAN</option>
                                                                                <option value="SURESH SNAP/AMOL  JALWALKAR">SURESH SNAP/AMOL  JALWALKAR</option>
                                                                                <option value="AMOL JALWALKAR">AMOL JALWALKAR</option>
                                                                                <option value="HITESH NAIK">HITESH NAIK</option>
                                                                                <option value="ATRA GLOBAL SOLUTION">ATRA GLOBAL SOLUTION</option>
                                                                                <option value="Direct Wlking">Direct Wlking</option>
                                                                                <option value="SURESH SNAP/DR.RAVI SINGH">SURESH SNAP/DR.RAVI SINGH</option>
                                                                                <option value="Mr.Kadwin k Pillai">Mr.Kadwin k Pillai</option>
                                                                                <option value="SURESH SNAP/PRANALI">SURESH SNAP/PRANALI</option>
                                                                                <option value="SURESH SNAP/SARUK">SURESH SNAP/SARUK</option>
                                                                                <option value="SURESH SNAP/Sonal David">SURESH SNAP/Sonal David</option>
                                                                                <option value="DRONACHRYA">DRONACHRYA</option>
                                                                                <option value="KOMAL KOTWAL">KOMAL KOTWAL</option>
                                                                                <option value="SURESH SNAP/JESURAJ(All Saints)">SURESH SNAP/JESURAJ(All Saints)</option>
                                                                                <option value="SURESH SNAP/DR.ANCHIT">SURESH SNAP/DR.ANCHIT</option>
                                                                                <option value="Cancelled">Cancelled</option>
                                                                                <option value="DRYANGLE">DRYANGLE</option>
                                                                                <option value="KUNAL">KUNAL</option>
                                                                                <option value="St.Johns">St.Johns</option>
                                                                                <option value="Limra">Limra</option>
                                                                                <option value="SG-Consultant">SG-Consultant</option>
																	...
																	<li>
                                                                        <div class="form-group">
                                                                            <label>Remark</label>
                                                                            <textarea type="text" class="form-control" id="rmk11"
                                                                                      placeholder="Remark Here..."></textarea>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                <button type="button" onclick="approveForFinance('4','11')" class="btn btn-success">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
